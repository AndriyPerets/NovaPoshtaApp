...
export default function WeightScreen({navigation}: Props) {
	...
	return (
		<ScrollView style={styles.container}>
			...
			<TextInput autoFocus onChangeText={setWeight} returnKeyType={'done'} keyboardType={'numeric'} value={weight}
			           placeholder={'1'} mode={'outlined'} style={styles.input}
			           label={'Вес'} theme={inputTheme}/>
			<VerticalSpace height={16}/>
			<TextInput onChangeText={setCost} returnKeyType={'done'} keyboardType={'numeric'} value={cost} placeholder={'300'}
			           mode={'outlined'} style={styles.input}
			           label={'Оценочная стоимость'} theme={inputTheme}/>
			<VerticalSpace height={16}/>
			<TextInput onChangeText={setSeatsAmount} returnKeyType={'done'} keyboardType={'numeric'} value={seatsAmount}
			           placeholder={'1'} mode={'outlined'} style={styles.input}
